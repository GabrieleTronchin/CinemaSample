...
/// </summary>
public class AuditoriumCommandQueriesHandler : IRequestHandler<GetEntitiesCommand, IList<AuditoriumReadModel>>
{
    ...
    public async Task<IList<AuditoriumReadModel>> Handle(GetEntitiesCommand request, CancellationToken cancellationToken)
    {
